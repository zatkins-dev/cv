...
\cventry{2023-Present}{Graduate Research Assistant}{University of Colorado Boulder}{Boulder, CO}{}{
  ...
  \begin{itemize}%
    ...
    \item Currently developing implicit, full Lagrangian material point method solver for simulation of granular materials.
  \end{itemize}
...
\cventry{}{C}{Intermediate}{}{}{
  Experience developing PETSc-based finite element solvers in the context of computational solid mechanics.
